...
export default function CustomCursor() {
  ...
  return (
    <>
      <div
        ref={cursorRef}
        className="fixed top-0 left-0 w-8 h-8 border border-white/40 rounded-full pointer-events-none z-[9999] mix-blend-difference will-change-transform hidden md:block"
      />
      <div
        ref={dotRef}
        className="fixed top-0 left-0 w-1.5 h-1.5 bg-white rounded-full pointer-events-none z-[10000] mix-blend-difference will-change-transform hidden md:block"
      />
    </>
  );
}
